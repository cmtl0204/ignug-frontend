...
export class EnrollmentDetailsHttpService {
  ...
  sendRequest(enrollmentDetailId:string,payload: CreateEnrollmentDetailDto): Observable<EnrollmentDetailModel> {
    const url = `${this.API_URL}/${enrollmentDetailId}/send-request`;
